...
// Reuse a single Mongo connection across serverless warm starts
let __mongoConnected = false;

async function ensureDB() {
    if (!__mongoConnected && !globalThis.__ibMongoConnected) {
        await connectDB();
        globalThis.__ibMongoConnected = true;
    }
    __mongoConnected = true;
}
